...
ค่าในวงเล็บของเมธอด DrawRectangle ประกอบไปด้วย 4 พารามิเตอร์ ดังนี้: 1. myPen (ชนิด Pen) - เป็นอ็อบเจกต์ที่ใช้ระบุสี, ความหนา และสไตล์ของเส้นที่ใช้วาดสี่เหลี่ยม 2. 20 (x-coordinate) - ค่าตำแหน่งแนวนอน (แกน X) ของมุมซ้ายบนของสี่เหลี่ยม 3. 20 (y-coordinate) - ค่าตำแหน่งแนวตั้ง (แกน Y) ของมุมซ้ายบนของสี่เหลี่ยม 4. 100 (width) - ความกว้างของสี่เหลี่ยม 5. 100 (height) - ความสูงของสี่เหลี่ยม
...
**4. อธิบายประเภทของความผิดพลาด (Errors), Step Into, Step Over** 1. ประเภทของความผิดพลาด (Errors): - Syntax Errors: ผิดไวยากรณ์ เช่น ลืมเครื่องหมาย ; - Runtime Errors: เกิดตอนรันโปรแกรม เช่น แบ่งด้วยศูนย์ - Logical Errors: ผิดตรรกะ เช่น คำตอบผิดแต่ไม่มี Error 2. Step Into (F11):ใช้เพื่อเข้าไปดูโค้ดใน Method ที่เรียก 3. Step Over (F10):ใช้เพื่อข้าม Method โดยไม่เข้าไปในโค้ดภายใน
